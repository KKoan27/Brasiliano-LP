# 🥗 Brasiliano - Landing Page

![Badge em Desenvolvimento](http://img.shields.io/static/v1?label=STATUS&message=EM%20DESENVOLVIMENTO&color=GREEN&style=for-the-badge)

> Uma Landing Page desenvolvida para o restaurante fictício **Brasiliano**, focada em design responsivo e experiência do usuário.

## 📖 Sobre o Projeto

Este projeto consiste em uma Landing Page para um restaurante fictício, criada com o objetivo de **praticar e consolidar conceitos fundamentais** de desenvolvimento web front-end sem o uso de frameworks.
